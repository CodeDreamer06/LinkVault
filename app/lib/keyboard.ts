  ...
  return [
    {
      ...
      shortcuts: [
        ...
        { keys: [mod, shift, "1"], description: "Go to Library" },
        { keys: [mod, shift, "2"], description: "Go to Inbox" },
        { keys: [mod, shift, "3"], description: "Go to Favorites" },
        { keys: [mod, shift, "4"], description: "Go to Reading" },
        { keys: [mod, shift, "5"], description: "Go to Archived" },
        { keys: [mod, shift, "6"], description: "Go to Reminders" },
        { keys: [mod, shift, "7"], description: "Go to Analytics" },
        { keys: [mod, shift, "8"], description: "Go to Settings" },
    ...
    },
    {
      name: "Actions",
      shortcuts: [
        { keys: [mod, shift, "N"], description: "Capture new link" },
        { keys: [mod, shift, "F"], description: "Focus search" },
